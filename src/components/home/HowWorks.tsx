  ...
  return (
    <div className='overflow-hidden space-betwwen-sections'>
      <div className='home-container md:pt-0 overflow-hidden grid grid-cols-1 md:grid-cols-2 gap-[24px] md:gap-[200px] place-items-center relative'>
        <div className="relative w-[800px] h-[800px]  z-10 after:absolute after:content-[''] after:w-[471px] after:top-[50%] after:left-[50%] after:translate-x-[-50%] after:translate-y-[-50%] after:h-[313px] after:blur-[162px] after:z-[-1] after:bg-[rgba(117,36,215,0.41)] order-2 md:order-1">
          <Image
